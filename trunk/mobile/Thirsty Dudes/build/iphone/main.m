...
NSString * const TI_APPLICATION_ID = @"com.thirstydudes.mobile";
...
NSString * const TI_APPLICATION_VERSION = @"1.9.1";
...
NSString * const TI_APPLICATION_GUID = @"c9637df9-d7a7-4320-9afc-887ba409c640";
