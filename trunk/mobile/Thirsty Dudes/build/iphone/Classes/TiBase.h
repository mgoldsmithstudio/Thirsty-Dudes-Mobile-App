...
// in simulator we redefine to format for ThirstyDudes Developer console
...
{\
	NSString * exceptionName = [@"org.thirstydudes." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.thirstydudes";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIThirstyDudesNativeItemNone = -1, 
	UIThirstyDudesNativeItemSpinner = -2,
	UIThirstyDudesNativeItemProgressBar = -3,
	
	UIThirstyDudesNativeItemSlider = -4,
	UIThirstyDudesNativeItemSwitch = -5,
	UIThirstyDudesNativeItemMultiButton = -6,
	UIThirstyDudesNativeItemSegmented = -7,
	
	UIThirstyDudesNativeItemTextView = -8,
	UIThirstyDudesNativeItemTextField = -9,
	UIThirstyDudesNativeItemSearchBar = -10,
	
	UIThirstyDudesNativeItemPicker = -11,
	UIThirstyDudesNativeItemDatePicker = -12,
	
	UIThirstyDudesNativeItemInfoLight = -13,
	UIThirstyDudesNativeItemInfoDark = -14,
	
	UIThirstyDudesNativeItemDisclosure = -15,
	
	UIThirstyDudesNativeItemContactAdd = -16
};
